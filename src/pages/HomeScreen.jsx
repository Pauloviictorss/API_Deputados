            ...
            <Row>
                <Col>
                    <Card className='p-2 mb-4 bg-light'>
                            ...
                            {eventos.slice(0,4).map(item => (
                                <Col>
                                    <Card className='bg-light my-2 p-2'>
                                        <h5><Link className="btn btn-warning w-100" to={'/detalhesevento/' + item.id}>{item.descricaoTipo.slice(0,20)}</Link></h5>
                        ...
                        <Link to={'/eventos?pagina=1&itens=10000'} className='btn btn-warning'>Ver mais</Link>
                    </Card>
                </Col>
            </Row>
            ...
            <Row className='mb-4'>
                <Col>
                    <Card className='p-2 bg-light'>
                        ...
                        <Link to={'/partidos'} className='btn btn-warning'>Ver todos os Partidos</Link>
                    </Card>
                </Col>
                    ...
                    <Card className='p-2 bg-light'>
                        ...
                        <InputGroup className="mt-4 mb-2">
                            ...
                            {deputados.slice(0,6).map(item => (
                                <Col >
                                    <Card className='bg-light align-items-center my-2'>
                                        <h5><Link className="btn btn-light w-100" to={'/detalhesdeputado/' + item.id}>{item.nome.slice(0,12)}...</Link></h5>
                                    </Card>
                                </Col>
                            ))}
                            </Row>
                        <Link to={'/deputados'} className='btn btn-warning'>Ver todos os Deputados</Link>
                    </Card>
                </Col>
            </Row>
